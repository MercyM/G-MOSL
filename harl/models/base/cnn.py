...
class CNNBaseGraph(nn.Module):
    """A CNN base module for actor and critic."""

    def __init__(self, args, obs_shape):
        super(CNNBaseGraph, self).__init__()
...
class CNNBaseGraphCritic(nn.Module):
    """A CNN base module for actor and critic."""

    def __init__(self, args, obs_shape, num_agents, share_obs_shape):
        super(CNNBaseGraphCritic, self).__init__()
        ...
        self.cnn = CNNLayer(
            obs_shape * num_agents + share_obs_shape,
