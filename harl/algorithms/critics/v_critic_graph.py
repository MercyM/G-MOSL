...
class VCriticGraph:
    ...
    def __init__(self, args, cent_obs_space, device=torch.device("cpu"), obs_space=None,num_agents=None):
        self.args = args
        self.device = device
        ...
        self.critic = VNet(args, self.share_obs_space, self.device, obs_space=obs_space,num_agents=num_agents)
    ...
    def get_values(self, cent_obs, rnn_states_critic, masks, infors):
        ...
        """
        values, rnn_states_critic = self.critic(cent_obs, rnn_states_critic, masks, infors)
    ...
    def update(self, sample, value_normalizer=None):
        ...
        values, _ = self.get_values(
            share_obs_batch, rnn_states_critic_batch, masks_batch, infors_batch
        )
